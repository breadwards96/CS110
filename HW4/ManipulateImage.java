...
//Date: 10/17/17
//File: ManipulateImage.java
//Honor Code: I pledge that this submission is solely my work,
//and that I have neither given to nor received help from anyone
//other than the instructor or TAs.


// An example of File class.
// This is much more sophisticated than needed for the final project.  
//
// Use the File examples from class and later examples for the final project.
// Also uses try-catch for error handling.
// This is also not required for the final project.

// Use the File class in the main method for the final project
...
public class ManipulateImage {
   ...
   public static void printImageInfo(BufferedImage buff, String imageFilename) {
      ...
      System.out.println("The image " + imageFilename + " has a height of "
         + imageHeight + " pixels.");
   
      System.out.println("The image " + imageFilename + " have a width of "
         + imageWidth + " pixels.");
   
      System.out.println("The image " + imageFilename + " is of type " 
         + imageType);
   ...
   public static void main(String[] args) {
      ...
      while (true) {
         ...
         if (action.equals("v")) {
            ...
            System.out.println("The image " + fileName + " has been inverted, and saved to " + fileNameOutput);
         } else if (action.equals("b")) {
